...
int main(int argc, char** argv) 
{
    ...
    if (argc != 2)
    {
        std::cout << "Usage: ./agramfiledemonstrator <filename> " << std::endl;
    ...
    std::cout << "Decoding AGRAM file " << filename << std::endl;
    ...
    if (fh)
    {
        ...
        {   
            adcp_coredata_messages::SDSP_v1_0_ADCPGram msg;
    ...
    {
        std::cout << "Couldn't open AGRAM file " << filename << std::endl;
    }
